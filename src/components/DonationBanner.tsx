            ...
            <div className="flex flex-col md:flex-row items-center gap-6 md:gap-10">
              <div className="flex-1 text-center md:text-left space-y-3">
                ...
                <h3 className="text-2xl md:text-3xl font-bold">
                  Help Keep Civil Rights Hub{" "}
                  <span className="bg-gradient-to-r from-primary to-blue-400 bg-clip-text text-transparent">
                    Free to Use
                  </span>
                </h3>
                <p className="text-muted-foreground max-w-lg">
                  Civil Rights Hub is built by We The People News. Contributions help support hosting,
                  public-records tools, source verification, rights-reference maintenance, and continued development.
                </p>
