  ...
  const createThread = async () => {
    ...
    if (title.trim().length < 4 || content.trim().length < 10) {
      toast({
        ...
        description: "Use a descriptive title and at least a short explanation.",
        variant: "destructive",
      });
      return;
    }
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Community threads are user-submitted. Share firsthand information carefully and link sources when making factual claims.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-3">
          ...
          <Textarea
            ...
            placeholder="Add context, questions, or source links."
            className="min-h-[120px]"
            maxLength={10000}
          />
          <div className="flex justify-end">
            <Button onClick={createThread} disabled={submitting || !title.trim() || !content.trim()}>
