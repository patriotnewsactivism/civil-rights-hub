    ...
    <div className="space-y-6">
      <div>
        <h2 className="flex items-center gap-2 text-2xl font-bold">
          <Users className="h-6 w-6" /> Community network
        </h2>
        <p className="mt-1 text-sm text-muted-foreground">
          Discover members who chose to make their profiles public. Civil Rights Hub does not infer or display professional credentials here.
        </p>
      </div>
      ...
      {loading ? (
        ...
        <Card className="border-dashed">
          <CardContent className="py-10 text-center text-sm text-muted-foreground">
            No matching public profiles yet.
          </CardContent>
        </Card>
      ) : (
                ...
                <CardContent className="space-y-4 p-5">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="min-w-0">
                      ...
                      {location && <div className="truncate text-xs text-muted-foreground">{location}</div>}
                    </div>
                  </div>
