...
(
  ...
  'YouTube',
  'https://www.youtube.com/@CopwatchPatrolUnitNYC',
  ARRAY['Copwatch', 'Police Accountability', 'Community Self-Defense'],
  'New York',
  'Founder of Copwatch Patrol Unit in New York City, documenting NYPD abuses and training community members on their rights.',
  true
),
(
  'Johnny 5-0',
...
(
  ...
  ARRAY['Police Accountability', 'First Amendment Audits', 'Local Government Oversight'],
  'Washington',
  'Seattle-based journalist behind GSG News who documents policing practices in the Pacific Northwest and fights prior restraint.',
  true
),
(
  'Armed Fisherman',
  ...
  'Florida',
  'Florida-based auditor known for lawful open-carry fishing demonstrations that test police understanding of state preemption laws.',
  true
),
(
  'Delaware Press Gang',
