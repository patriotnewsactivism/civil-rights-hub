...
(
  ...
  'YouTube',
  'https://www.youtube.com/@copwatchpatrolunit',
  ARRAY['Copwatch Response', 'Police Accountability', 'Community Organizing', 'Government Transparency'],
  'New York',
  'Founder of Copwatch Patrol Unit in New York City, coordinating rapid-response teams that document NYPD encounters and support families impacted by police violence.',
  true
),
(
  'Johnny 5-0',
...
(
  ...
  'GSG News',
  'YouTube',
  'https://www.youtube.com/@GSGNews',
  ARRAY['Police Activity Monitoring', 'Government Transparency', 'First Amendment Audits'],
  'Washington',
  'Founder of GSG News in the Seattle-Tacoma area, live streaming breaking news, police activity, and accountability reporting grounded in Washington-based copwatch work.',
  true
),
(
  'Armed Fisherman',
  ...
  ARRAY['First Amendment Audits', 'Police Accountability', 'Constitutional Rights Education'],
  'Florida',
  'Florida-based auditor and angler who lawfully open carries while fishing to educate the public on Second and First Amendment protections along the coast.',
  true
),
(
  'Delaware Press Gang',
