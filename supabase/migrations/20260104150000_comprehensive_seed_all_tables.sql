...
VALUES
  ...
  ('Unlawful Search During Protest', 'During a peaceful protest, police conducted warrantless searches of backpacks without probable cause.', 'New York', 'New York City', '2025-11-22', 40.7128, -74.0060, 'investigating'),
  ...
  ('First Amendment Retaliation', 'Arrested for filming police from public property. All charges were later dropped.', 'Florida', 'Miami', '2025-12-20', 25.7617, -80.1918, 'investigating')
ON CONFLICT DO NOTHING;

-- Seed violation_comments (ensure parent violations exist)
INSERT INTO violation_comments (violation_id, comment, author_name)
SELECT
  v.id,
