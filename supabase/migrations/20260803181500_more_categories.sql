...
--
-- Version 20260803181500 (`more_categories`) is already recorded as applied in
-- the Civil Rights Hub production Supabase project (vrdnrbjnitptxrexdlao).
--
-- The original remote migration bulk-seeded state_rights_comparison with
-- unsourced state-by-state claims about stand-your-ground law, open carry, and
-- expungement availability. Those claims do not satisfy the current provenance
-- standard and the corresponding public surface is fail-closed by later
